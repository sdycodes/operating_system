...
clean: 
	...
	rm -rf *.o *~ $(vmlinux_elf)
start:
	/OSLAB/gxemul -E testmips -C R3000 -M 64 -d gxemul/fs.img ~/16721145-lab/gxemul/vmlinux
debug:
	/OSLAB/gxemul -E testmips -C R3000 -M 64 -v -V -d gxemul/fs.img ~/16721145-lab/gxemul/vmlinux
include include.mk
